...
class LandingPage extends PureComponent {
    ...
    render() {
        ...
        const cardData = courses.courses.map((course) => {
        ...
        const filteredCardData = courses.courses.map((course) => {
        ...
        console.log(this.dynamicSearch() === null ? "true" : "false")
        console.log(cardData ? "true" : "false")
        return (
            <div className={classes.lpText} >
                ...
                <div className={classes.landingPageContainer}>
                    <div className={classes.searchBox}>
                        ...
                        } onChange={this.editSearchTerm} placeholder='Search By Course!' />
                        <br></br>
                        {this.state.searchTerm === '' ? null : <h1 className={classes.searchResults}><NamesContainer names={this.dynamicSearch()} /></h1>}
                    </div>
                ...
                <div className={classes.cards}>
                    ...
                    {this.state.pageCount >= 2 ? <NoCourseFound /> : null}
                </div>
